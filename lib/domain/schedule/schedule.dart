...
class Schedule {
  ...
  final ScheduleId id;
  // スケジュールのオーナーPhotoUrl
  final AvatarUrl _ownerUrl;
  // タイトル
  final ScheduleTitle _title;
  // 備考欄
  final ScheduleRemarks _remarks;
  // 候補日
  final List<ScheduleDate> _scheduleList;
  // 参加者
  final List<UserId> _userList;
  // 回答済み参加者
  final List<UserId> _answerUserList;
